...
//    error_list[DBUSTOE].solveDataErrorFun = slove_data_error;
    ...
    // error_list[MINI_PC_TOE].data_is_error_fun =  NUC_data_is_error;
    // error_list[MINI_PC_TOE].solveLostFun = solve_NUC_lost;
    // error_list[MINI_PC_TOE].solveDataErrorFun = solve_NUC_data_error;
}
